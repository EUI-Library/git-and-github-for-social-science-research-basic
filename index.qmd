...
## Start a project using GitHub Desktop {.smaller}
...
2. Browse your GitHub repos or paste a URL (e.g. our demo repo: [add demo URL])
3. Choose a local folder → **Clone**

::: {.callout-tip}
The repository now lives both **on your computer** and on **GitHub**
:::

# Let's do it together {style="text-align: center;" .center}
